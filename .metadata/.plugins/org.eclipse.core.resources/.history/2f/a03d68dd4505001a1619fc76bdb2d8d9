...
**     Date/Time   : 2019-11-05, 17:14, # CodeGen: 1
**     Abstract    :
...
void main_task(os_task_param_t task_init_data)
{
  ...
  while (status != kStatus_OSA_Success) {
	  status = OSA_SemaCreate(&mySema, 0);
  }
